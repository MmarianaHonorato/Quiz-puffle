class ResultadoPuffles {
    constructor() {
        this.puffleVencedor = localStorage.getItem("puffleVencedor");
        this.pufflePontuacao = localStorage.getItem("pufflePontuacao");
        ...
        this.elementoNome = document.getElementById("puffle-nome");
        this.elementoPontuacao = document.getElementById("puffle-pontuacao");
        this.elementoSubtitulo = document.getElementById("subtitulo-puffle");
        this.elementoTexto = document.getElementById("texto-puffle");
        this.img1 = document.getElementById("img-1");
        this.img2 = document.getElementById("img-2");
        this.img3 = document.getElementById("img-3");
    }

    exibirDados() {
        if (this.puffleVencedor && this.dadosResultado[this.puffleVencedor]) {
            const dados = this.dadosResultado[this.puffleVencedor];
            
            this.elementoNome.textContent = dados.nome;
            
            this.elementoSubtitulo.textContent = dados.subtitulo;
            this.elementoTexto.textContent = dados.texto;
            this.elementoPontuacao.textContent = `seu resultado é: ${this.pufflePontuacao} pontos `;
            this.img1.src = dados.img1;
            this.img2.src = dados.img2;
            this.img3.src = dados.img3;
        }
    }
}

const telaResultado = new ResultadoPuffles();
telaResultado.exibirDados();